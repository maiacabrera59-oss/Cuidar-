        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="lg:hidden">
            ...
            <div className="space-y-5 mt-10">
              {/* SANGRE */}
              <div className="profile-card bg-white rounded-[30px] p-6 border border-gray-200 shadow-sm">
                <p className="text-[#747970] text-sm font-medium">
                  Grupo sanguíneo
                </p>
                <h3 className="text-6xl font-bold tracking-tight mt-4 text-[#2E7D32] animate-[bloodTypeAppear_.4s_ease-out]">
                  {paciente.sangre}
                </h3>
              ...
              <div className="profile-card bg-white rounded-[30px] p-6 border border-gray-200 shadow-sm">
                ...
                <button className="mt-5 text-[#2E7D32] font-semibold">
                  Ver en el mapa
                </button>
              </div>
          ...
          <div className="hidden lg:grid lg:grid-cols-[380px_1fr] gap-6 mt-10">
            ...
            {/* PERFIL IZQUIERDA */}
            <div className="profile-card bg-white rounded-[32px] border border-gray-200 shadow-sm p-8 h-fit">
              <img
                src={paciente.foto}
                alt={paciente.nombre}
                className="
              ...
              <button className="w-full mt-10 bg-[#2E7D32] text-white rounded-2xl py-4 font-bold text-lg shadow-sm">
                Editar Perfil
              </button>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* SANGRE */}
              <div className="profile-card bg-white rounded-[32px] p-8 border border-gray-200 shadow-sm">
                <p className="text-[#747970] text-base">
                  Grupo sanguíneo
                </p>
                <h3 className="text-8xl font-bold tracking-tight mt-6 text-[#2E7D32] animate-[bloodTypeAppear_.4s_ease-out]">
                  {paciente.sangre}
                </h3>
              ...
              <div className="profile-card bg-white rounded-[32px] p-8 border border-gray-200 shadow-sm">
                ...
                <div className="flex gap-4 mt-8">
                  <button className="flex-1 bg-[#2E7D32] text-white rounded-2xl py-4 font-semibold">
                    Llamar
                  </button>
                  <button className="flex-1 bg-[#F5F5F5] border border-gray-200 rounded-2xl py-4 font-semibold">
                    SMS
                  </button>
                </div>
              </div>
